...
<template>
  <nav
    class="w-screen bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm shadow px-4 sm:px-6 lg:px-8"
  >
    <div class="max-w-3xl mx-auto h-16 flex items-center justify-between space-x-2">
      <router-link
        v-for="link in links"
        :key="link.to"
        :to="link.to"
